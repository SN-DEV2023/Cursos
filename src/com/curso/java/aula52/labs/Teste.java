...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        int opcao = 0; // Inicialize a opção com um valor diferente de 3 para entrar no loop

        while (opcao != 3) {
            opcao = obterOpcaoMenu(scan); // Move a chamada para dentro do loop
	...
	public static void adicionarContato(Scanner scan, Agenda agenda) {
		try {
			...
			String email = leInformacaoString(scan, "Entre com o email de contato");
